...
public class SollwertNacht {

	public static double sollwertNacht()
	{
		...
		eingabe = JOptionPane.showInputDialog(null, "Geben Sie eine Nachtsolltemperatur zwischen 16°C und 25°C ein.",JOptionPane.PLAIN_MESSAGE);
